...
//        System.out.println(Arrays.toString(InvoiceGenerator.instance().generateInvoiceCodeAndNumberValidateByPdfAndQrcode(path)));
    ...
    public static void testGenerateInvoidCodeAndNumber(String path) throws Exception {
        ...
        System.out.println("QR: "+Arrays.toString(InvoiceGenerator.instance(null).generateInvoiceCodeAndNumber(path, false, true, false, 0.65, 0, 1, 0.25)));
        System.out.println("OCR: "+Arrays.toString(InvoiceGenerator.instance(null).generateInvoiceCodeAndNumber(path, false, false, true, 0.65, 0, 1, 0.25)));
        path = "D:\\log\\pdf\\031001600211_46627938(1)-KenDeJi.pdf";
        System.out.println("PDF: "+Arrays.toString(InvoiceGenerator.instance(null).generateInvoiceCodeAndNumber(path, true, false, false, 0.65, 0, 1, 0.25)));
        System.out.println("QR: "+Arrays.toString(InvoiceGenerator.instance(null).generateInvoiceCodeAndNumber(path, false, true, false, 0.65, 0, 1, 0.25)));
        System.out.println("OCR: "+Arrays.toString(InvoiceGenerator.instance(null).generateInvoiceCodeAndNumber(path, false, false, true, 0.65, 0, 1, 0.25)));
